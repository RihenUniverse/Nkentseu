...
namespace nkentseu {
    ...
    class NKENTSEU_API NkBinaryStream : public NkStream {
        public:
            ...
            usize ReadRaw(void* buffer, usize byteCount) override {
                ...
                MemorySystem::Copy(buffer, mBuffer + mPosition, toRead);
                mPosition += toRead;
                return toRead;
            }
            ...
            usize WriteRaw(const void* data, usize byteCount) override {
                ...
                MemorySystem::Copy(mBuffer + mPosition, data, byteCount);
                mPosition += byteCount;
        ...
        private:
            ...
            void Reallocate(usize newCapacity) {
                ...
                MemorySystem::Copy(newBuffer, mBuffer, mSize);
                if(mOwned) delete[] mBuffer;
                mBuffer = newBuffer;
