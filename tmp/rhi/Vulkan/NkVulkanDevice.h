...
namespace nkentseu {
        ...
        // =============================================================================
        // NkVulkanDevice (autonome avec NkSurfaceDesc)
        // =============================================================================
        class NkVulkanDevice final : public NkIDevice {
            public:
                ...
                // Initialize avec une description de surface
                bool          Initialize(const NkSurfaceDesc& surfaceDesc);
                ...
                // ── Accès interne (pour NkCommandBuffer_VK) ───────────────────────────────
            ...
            private:
                ...
                bool CreateSurface(const NkSurfaceDesc& surfaceDesc);
                ...
                bool CreateSwapchain(uint32 w, uint32 h);
                ...
                bool FindMemoryType(uint32 filter, VkMemoryPropertyFlags props, uint32& out) const;
                void QueryCaps();
                ...
                // Surface et swapchain
                VkSurfaceKHR     mSurface     = VK_NULL_HANDLE;
                VkSwapchainKHR   mSwapchain   = VK_NULL_HANDLE;
                VkFormat         mSwapFormat  = VK_FORMAT_B8G8R8A8_SRGB;
                VkColorSpaceKHR  mSwapColorSpace = VK_COLOR_SPACE_SRGB_NONLINEAR_KHR;
                ...
                // Command pools pour graphics et compute
                VkCommandPool mGraphicsCmdPool = VK_NULL_HANDLE;
                VkCommandPool mComputeCmdPool = VK_NULL_HANDLE;

                // Frame data (triple buffering)
                static constexpr uint32 kMaxFrames = 3;
                static constexpr uint32 kMaxImages = 8;
                NkVkFrameData mFrames[kMaxFrames];
                VkFence       mImagesInFlight[kMaxImages];
        ...
        class NkVulkanDevice final : public NkIDevice {
            public:
                bool Initialize(const NkSurfaceDesc&) { return false; }
                void Shutdown() override {}
