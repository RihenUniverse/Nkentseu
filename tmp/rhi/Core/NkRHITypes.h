...
namespace nkentseu {
    ...
    enum class NkGPUFormat : uint32 {
        ...
        NK_RGBA8_UNORM, NK_RGBA8_SNORM, NK_RGBA8_UINT, NK_RGBA8_SINT,
        NK_RGBA8_SRGB,
    ...
    // Utilitaires format
    inline bool NkGPUFormatIsDepth(NkGPUFormat f) {
    ...
    inline bool NkGPUFormatHasStencil(NkGPUFormat f) {
        return f==NkGPUFormat::NK_D24_UNORM_S8_UINT || f==NkGPUFormat::NK_D32_FLOAT_S8_UINT;
    }
    inline bool NkGPUFormatIsSrgb(NkGPUFormat f) {
    ...
    inline uint32 NkGPUFormatBytesPerPixel(NkGPUFormat f) {
        switch(f) {
    ...
    enum class NkVertexFormat : uint32 {
        NK_FLOAT1, NK_FLOAT2, NK_FLOAT3, NK_FLOAT4,
        NK_HALF2,  NK_HALF4,
        NK_BYTE4_UNORM, NK_BYTE4_SNORM,
        NK_USHORT2_UNORM, NK_USHORT4_UNORM,
        NK_UINT1, NK_UINT2, NK_UINT4,
        NK_INT1,  NK_INT2,  NK_INT4,
    };

    inline uint32 NkVertexFormatSize(NkVertexFormat f) {
        switch(f) {
            case NkVertexFormat::NK_FLOAT1: return 4;
            case NkVertexFormat::NK_FLOAT2: return 8;
            case NkVertexFormat::NK_FLOAT3: return 12;
            case NkVertexFormat::NK_FLOAT4: return 16;
            case NkVertexFormat::NK_HALF2:  return 4;
            case NkVertexFormat::NK_HALF4:  return 8;
            case NkVertexFormat::NK_BYTE4_UNORM:
            case NkVertexFormat::NK_BYTE4_SNORM: return 4;
            case NkVertexFormat::NK_USHORT2_UNORM: return 4;
            case NkVertexFormat::NK_USHORT4_UNORM: return 8;
            case NkVertexFormat::NK_UINT1:  return 4;
            case NkVertexFormat::NK_UINT2:  return 8;
            case NkVertexFormat::NK_UINT4:  return 16;
            case NkVertexFormat::NK_INT1:   return 4;
            case NkVertexFormat::NK_INT2:   return 8;
            case NkVertexFormat::NK_INT4:   return 16;
            default:                     return 0;
        }
    }
