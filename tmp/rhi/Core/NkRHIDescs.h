...
namespace nkentseu {
    ...
    struct NkVertexAttribute {
        ...
        NkVertexFormat format     = NkVertexFormat::NK_FLOAT3;
    ...
    struct NkVertexLayout {
        ...
        static NkVertexLayout PosOnly() {
            NkVertexLayout l;
            l.AddBinding(0,12).AddAttribute(0,0,NkVertexFormat::NK_FLOAT3,0,"POSITION");
            return l;
        }
        static NkVertexLayout PosNormUV() {
            NkVertexLayout l;
            l.AddBinding(0,32)
            .AddAttribute(0,0,NkVertexFormat::NK_FLOAT3, 0,"POSITION")
            .AddAttribute(1,0,NkVertexFormat::NK_FLOAT3,12,"NORMAL")
            .AddAttribute(2,0,NkVertexFormat::NK_FLOAT2,24,"TEXCOORD");
            return l;
        }
        static NkVertexLayout PosNormTanUV() {
            ...
            .AddAttribute(0,0,NkVertexFormat::NK_FLOAT3, 0,"POSITION")
            .AddAttribute(1,0,NkVertexFormat::NK_FLOAT3,12,"NORMAL")
            .AddAttribute(2,0,NkVertexFormat::NK_FLOAT4,24,"TANGENT")
            .AddAttribute(3,0,NkVertexFormat::NK_FLOAT2,40,"TEXCOORD");
            return l;
        }
        static NkVertexLayout PosColUV() {
            ...
            l.AddBinding(0,24)
            .AddAttribute(0,0,NkVertexFormat::NK_FLOAT3, 0,"POSITION")
            .AddAttribute(1,0,NkVertexFormat::NK_BYTE4_UNORM,12,"COLOR")
            .AddAttribute(2,0,NkVertexFormat::NK_FLOAT2,16,"TEXCOORD");
            return l;
        }
    };
    ...
    struct NkBlendDesc {
        ...
        static NkBlendDesc Alpha()   { NkBlendDesc d; d.attachments.PushBack(NkBlendAttachment::Alpha()); return d; }
        static NkBlendDesc Additive(){ NkBlendDesc d; d.attachments.PushBack(NkBlendAttachment::Additive()); return d; }
    };
