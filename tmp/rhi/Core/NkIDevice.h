...
//
// Architecture :
//   NkSurfaceDesc (couche 0)  →  NkIDevice (couche 1)
//
// Un NkIDevice est créé depuis un NkSurfaceDesc existant.
...
namespace nkentseu {
    ...
    public:
        ...
        virtual bool         Initialize(NkSurfaceDesc* ctx)   = 0;
