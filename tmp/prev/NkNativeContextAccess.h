...
#include "NKContext/Backends/OpenGL/NkOpenGLContextData.h"
#include "NKContext/Backends/Vulkan/NkVulkanContextData.h"

#if defined(NKENTSEU_PLATFORM_WINDOWS)
#   include "NKContext/Backends/DirectX/NkDirectXContextData.h"
#endif
