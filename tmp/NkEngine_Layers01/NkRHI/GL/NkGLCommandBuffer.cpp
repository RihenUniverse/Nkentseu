...
// Ces helpers sont inline-friend dans NkDevice_GL — ici on les déclare extern
extern GLuint   NkOpenglGetBufferID (NkDevice_GL* dev, uint64 id);
extern GLuint   NkOpenglGetTextureID(NkDevice_GL* dev, uint64 id);
extern GLuint   NkOpenglGetFBOID    (NkDevice_GL* dev, uint64 id);
extern GLuint   NkOpenglGetSamplerID(NkDevice_GL* dev, uint64 id);
extern void     NkOpenglApplyRenderState(NkDevice_GL* dev, uint64 pipelineId);
extern GLuint   NkOpenglGetProgramID(NkDevice_GL* dev, uint64 id);
extern GLuint   NkOpenglGetVAOID   (NkDevice_GL* dev, uint64 id);
extern GLenum   NkOpenglGetPrimitive(NkDevice_GL* dev, uint64 id);
extern bool     NkOpenglIsCompute   (NkDevice_GL* dev, uint64 id);
extern void     NkOpenglApplyDescSet(NkDevice_GL* dev, uint64 setId,
                                   const std::vector<uint32>& dynOff);

// =============================================================================
void NkCommandBuffer_GL::Execute(NkDevice_GL* dev) {
    mDev = dev;
    for (auto& cmd : mCmds) cmd();
}

// =============================================================================
void NkCommandBuffer_GL::GL_BeginRenderPass(NkRenderPassHandle rp,
    ...
    // (accès via NkDevice_GL::GetRenderPassDesc — méthode publique)
...
// =============================================================================
void NkCommandBuffer_GL::GL_BindGraphicsPipeline(NkPipelineHandle p) {
...
// =============================================================================
void NkCommandBuffer_GL::GL_BindComputePipeline(NkPipelineHandle p) {
    mCurrentProgram = NkOpenglGetProgramID(mDev, p.id);
    mIsCompute      = true;
    glUseProgram(mCurrentProgram);
}
...
// =============================================================================
void NkCommandBuffer_GL::GL_BindDescriptorSet(NkDescSetHandle set, uint32 idx,
                                               const std::vector<uint32>& dynOff) {
...
// =============================================================================
void NkCommandBuffer_GL::GL_BindVertexBuffer(uint32 binding,
    ...
    glBindVertexBuffer((GLuint)binding, bufId, (GLintptr)off, 0);
    ...
    // C'est le cas dans NkDevice_GL::CreateGraphicsPipeline.
}

// =============================================================================
void NkCommandBuffer_GL::GL_BindIndexBuffer(NkBufferHandle buf,
...
// =============================================================================
void NkCommandBuffer_GL::GL_BindForIndirect(NkBufferHandle buf) {
    GLuint bufId = NkOpenglGetBufferID(mDev, buf.id);
    glBindBuffer(GL_DRAW_INDIRECT_BUFFER, bufId);
}

// =============================================================================
void NkCommandBuffer_GL::GL_CopyBuffer(NkBufferHandle src, NkBufferHandle dst,
...
// =============================================================================
void NkCommandBuffer_GL::GL_CopyBufferToTexture(NkBufferHandle src,
...
// =============================================================================
void NkCommandBuffer_GL::GL_CopyTextureToBuffer(NkTextureHandle src,
...
// =============================================================================
void NkCommandBuffer_GL::GL_CopyTexture(NkTextureHandle src, NkTextureHandle dst,
...
// =============================================================================
void NkCommandBuffer_GL::GL_BlitTexture(NkTextureHandle src, NkTextureHandle dst,
    ...
    glBlitNamedFramebuffer(srcFBO,dstFBO,
        ...
        GL_COLOR_BUFFER_BIT,
        filter==NkFilter::Nearest ? GL_NEAREST : GL_LINEAR);
...
// =============================================================================
void NkCommandBuffer_GL::GL_GenerateMipmaps(NkTextureHandle tex) {
