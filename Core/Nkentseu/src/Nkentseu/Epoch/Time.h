/**
* @File Time.h
* @Description Définit la classe Time pour la gestion précise du temps quotidien avec nanosecondes
...
namespace nkentseu { // Début du namespace nkentseu
    ...
    /**
    * - Time : Représente un temps quotidien avec précision nanoseconde
    *
    * @Description :
    ...
    * - Les opérations arithmétiques entre objets Time
    ...
    *
    * @Members :
    * - (int32) m_Hour : Heure dans l'intervalle [0-23]
    * - (int32) m_Minute : Minute dans l'intervalle [0-59]
    * - (int32) m_Second : Seconde dans l'intervalle [0-59]
    * - (int32) m_Millisecond : Milliseconde dans l'intervalle [0-999]
    * - (int32) m_Nanosecond : Nanoseconde dans l'intervalle [0-999999]
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @Constructor Time par défaut
        * @Description : Initialise tous les composants temporels à zéro
        */
        Time() noexcept;
        
        /**
        * @Constructor Time à partir de composants
        * @Description : Construit un objet Time à partir de ses composants individuels
        ...
        */
        Time(int32 hour, int32 minute, int32 second, int32 millisecond = 0, int32 nanosecond = 0);
        
        /**
        * @Constructor Time à partir de nanosecondes
        * @Description : Construit un Time à partir d'un total de nanosecondes
        * @param (int64) totalNanoseconds : Nombre total de nanosecondes écoulées
        */
        explicit Time(int64 totalNanoseconds) noexcept;
        ...
        * @return (Time&) : Référence à l'objet modifié
        */
        ...
        */
        int32 GetMillisecond() const noexcept { return m_Millisecond; }
        ...
        */
        int32 GetNanosecond() const noexcept { return m_Nanosecond; }
        ...
        * @param (const Time&) other : Temps à ajouter
        * @return (Time&) : Référence à l'instance modifiée
        */
        ...
        * @param (const Time&) other : Temps à soustraire
        * @return (Time&) : Référence à l'instance modifiée
        */
        Time& operator-=(const Time& other) noexcept;
        ...
        * @param (const Time&) other : Temps à ajouter
        * @return (Time) : Nouvel objet Time résultant de l'addition
        */
        ...
        * @param (const Time&) other : Temps à soustraire
        * @return (Time) : Nouvel objet Time résultant de la soustraction
        */
        Time operator-(const Time& other) const noexcept;
        ...
        * @param (const Time&) other : Temps à comparer
        ...
        * @return (Time) : Instance Time représentant l'heure courante
        */
        ...
        * @param (const Time&) time : Temps à formater
        * @return (std::string) : Représentation formatée du temps
        */
        friend std::string ToString(const Time& time) {
            return time.ToString();
        }

    private:
        // Membres privés avec commentaires inline
        int32 m_Hour = 0;       // Heure [0-23]
        int32 m_Minute = 0;     // Minute [0-59]
        int32 m_Second = 0;     // Seconde [0-59]
        int32 m_Millisecond = 0;// Milliseconde [0-999]
        int32 m_Nanosecond = 0; // Nanoseconde [0-999999]
