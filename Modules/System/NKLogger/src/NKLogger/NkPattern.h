// -----------------------------------------------------------------------------
// FICHIER: Core/NkLogger/src/NkLogger/Pattern.h
 ...
 */
extern const char *NK_DEFAULT_PATTERN;

/**
 * @brief Pattern simple (juste le message)
 * Format: Message
 */
extern const char *NK_SIMPLE_PATTERN;
...
// =============================================================================
// EXEMPLES D'UTILISATION - NkPattern
// =============================================================================
//
//   // Placeholders frequents : %Y %m %d %H %M %S %l %v %n
//   NkString p = "[%Y-%m-%d %H:%M:%S] [%l] %v";
//
// =============================================================================
