...
// =============================================================================
// EXEMPLES D'UTILISATION - NkAsyncSink
// =============================================================================
//
//   memory::NkSharedPtr<NkISink> fileSink = memory::MakeShared<NkFileSink>("app.log");
//   memory::NkSharedPtr<NkISink> asyncSink = memory::MakeShared<NkAsyncSink>(fileSink);
//
// =============================================================================
