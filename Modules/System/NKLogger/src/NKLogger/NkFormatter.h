...
// =============================================================================
// EXEMPLES D'UTILISATION - NkFormatter
// =============================================================================
//
//   NkFormatter fmt(NkFormatter::NK_DETAILED_PATTERN);
//   NkLogMessage msg(NkLogLevel::NK_INFO, "Demarrage");
//   NkString out = fmt.Format(msg, true);
//
// =============================================================================
