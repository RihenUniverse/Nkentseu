...
struct NkSLResolvedType {
    NkSLBaseType  base      = NkSLBaseType::UNKNOWN;
    ...
    bool IsVoid()    const { return base == NkSLBaseType::VOID; }
    bool IsScalar()  const { return base>=NkSLBaseType::BOOL  && base<=NkSLBaseType::DOUBLE; }
    bool IsVector()  const { return base>=NkSLBaseType::IVEC2 && base<=NkSLBaseType::DVEC4; }
    bool IsMatrix()  const { return base>=NkSLBaseType::MAT2  && base<=NkSLBaseType::DMAT4; }
    ...
    bool IsFloat()   const {
        return base==NkSLBaseType::FLOAT ||
               (base>=NkSLBaseType::VEC2 && base<=NkSLBaseType::VEC4) ||
               IsMatrix();
    }
    ...
    static NkSLResolvedType Void()  { return {NkSLBaseType::VOID}; }
    static NkSLResolvedType Bool()  { return {NkSLBaseType::BOOL}; }
    static NkSLResolvedType Int()   { return {NkSLBaseType::INT}; }
    static NkSLResolvedType UInt()  { return {NkSLBaseType::UINT}; }
    static NkSLResolvedType Float() { return {NkSLBaseType::FLOAT}; }
    static NkSLResolvedType Vec2()  { return {NkSLBaseType::VEC2}; }
    static NkSLResolvedType Vec3()  { return {NkSLBaseType::VEC3}; }
    static NkSLResolvedType Vec4()  { return {NkSLBaseType::VEC4}; }
    static NkSLResolvedType Mat3()  { return {NkSLBaseType::MAT3}; }
    static NkSLResolvedType Mat4()  { return {NkSLBaseType::MAT4}; }
...
struct NkSLSymbol {
    NkString                          name;
    NkSLSymbolKind                    kind    = NkSLSymbolKind::VARIABLE;
