// dof.frag.gl.glsl — NKRenderer v4.0 — Depth of Field Bokeh (OpenGL 4.6)
#version 460 core
...
layout(binding=2) uniform sampler2D tCoCMap;  // Circle of Confusion
layout(std140,binding=3) uniform DOFUBO{float focusDistance;float aperture;float focalLength;float maxBlur;float near,far,_p[2];}uDOF;
