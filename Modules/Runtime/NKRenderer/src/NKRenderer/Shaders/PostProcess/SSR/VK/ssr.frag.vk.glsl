// ssr.frag.vk.glsl — NKRenderer v4.0 — SSR (Vulkan)
#version 460 core
...
layout(set=1,binding=3) uniform sampler2D tORM;
layout(set=0,binding=4,std140) uniform SSRUBO{mat4 proj,invProj,view;float maxDistance,resolution,thickness;float _p;}uSSR;
