// foliage.vert.vk.glsl — NKRenderer v4.0 — Foliage Vertex (Vulkan)
...
layout(set=0,binding=9,std140) uniform FoliageUBO{float windStrength,windFrequency,windTurbulence,bendFactor;}uFoliage;
