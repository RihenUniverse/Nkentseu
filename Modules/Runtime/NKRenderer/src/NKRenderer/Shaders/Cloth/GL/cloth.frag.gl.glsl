// cloth.frag.gl.glsl — NKRenderer v4.0 — Cloth Ashikhmin-Shirley (OpenGL 4.6)
...
layout(std140,binding=7) uniform ClothUBO{vec4 sheenColor;float sheenRoughness;float anisotropy;float _p[2];}uCloth;
