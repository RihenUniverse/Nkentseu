// toon.vert.vk.glsl — Toon Vertex (Vulkan)
#version 460 core
...
void main(){vec4 wp=uObj.model*vec4(aPos,1.);vWorldPos=wp.xyz;vNormal=normalize(mat3(uObj.normalMatrix)*aNormal);vUV=aUV;vColor=aColor*uObj.tint;gl_Position=uCam.viewProj*wp;gl_Position.y=-gl_Position.y;}
