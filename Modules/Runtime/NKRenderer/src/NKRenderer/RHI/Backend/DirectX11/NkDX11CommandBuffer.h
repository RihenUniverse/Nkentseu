#pragma once
// =============================================================================
// NkCommandBuffer_DX11.h — Deferred Context DX11
...
class NkCommandBuffer_DX11 final : public NkICommandBuffer {
public:
    NkCommandBuffer_DX11(NkDeviceDX11* dev, NkCommandBufferType type);
    ~NkCommandBuffer_DX11() override;
