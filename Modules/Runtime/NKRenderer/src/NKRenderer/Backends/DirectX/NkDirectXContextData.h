...
// Compatibility for older MinGW/Windows SDK headers that may not expose the v5/v4 interfaces.
#if !defined(__ID3D12Device5_INTERFACE_DEFINED__) && !defined(ID3D12Device5)
    typedef ID3D12Device ID3D12Device5;
#endif
#if !defined(__ID3D12GraphicsCommandList4_INTERFACE_DEFINED__) && !defined(ID3D12GraphicsCommandList4)
