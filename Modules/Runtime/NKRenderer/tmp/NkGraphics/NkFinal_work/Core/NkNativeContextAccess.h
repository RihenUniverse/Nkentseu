...
#include "../OpenGL/NkOpenGLContextData.h"
#include "../Vulkan/NkVulkanContextData.h"

#if defined(NKENTSEU_PLATFORM_WINDOWS)
#   include "../DirectX/NkDirectXContextData.h"
#endif
...
namespace nkentseu {
    ...
    struct NkNativeContext {
        ...
        static NkOpenGLContextData* OpenGL(NkIGraphicsContext* ctx) {
            return NkGetNativeAs<NkOpenGLContextData>(ctx,
                ctx ? (ctx->GetApi() == NkGraphicsApi::NK_API_OPENGLES
                       ? NkGraphicsApi::NK_API_OPENGLES
                       : NkGraphicsApi::NK_API_OPENGL)
                    : NkGraphicsApi::NK_API_NONE);
        }
