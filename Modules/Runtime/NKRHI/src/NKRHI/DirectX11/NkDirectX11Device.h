...
namespace nkentseu {
    ...
    struct NkDX11Pipeline {
        ...
        uint32                     vertexStrides[D3D11_IA_VERTEX_INPUT_RESOURCE_SLOT_COUNT] = {};
    ...
    // =============================================================================
    class NkDirectX11Device final : public NkIDevice {
        public:
            NkDirectX11Device()  = default;
            ~NkDirectX11Device() override;
        ...
        private:
            ...
            uint32              mSwapchainBufferCount = 2;
            uint32              mMsaaSamples = 1;
            uint32              mMsaaQuality = 0;
            D3D_FEATURE_LEVEL   mMinFeatureLevel = D3D_FEATURE_LEVEL_11_0;
    };
