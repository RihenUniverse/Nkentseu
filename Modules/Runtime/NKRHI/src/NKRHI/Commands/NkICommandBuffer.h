...
namespace nkentseu {
    ...
    class NkICommandBuffer {
        public:
            ...
            // =========================================================================
            virtual void BeginDebugGroup(const nk_char* name, float32 r=1, float32 g=1, float32 b=1) {}
            virtual void EndDebugGroup()   {}
            virtual void InsertDebugLabel(const nk_char* name) {}
