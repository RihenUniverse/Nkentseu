...
NkString NkSLCodeGen_CPP::BaseTypeToCPP(NkSLBaseType t) {
    switch (t) {
        ...
        case NkSLBaseType::NK_INT:    return "int32_t";
        ...
        case NkSLBaseType::NK_UINT:   return "uint32_t";
