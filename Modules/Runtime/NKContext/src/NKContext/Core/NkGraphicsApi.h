...
namespace nkentseu {
    ...
    inline bool NkGraphicsApiIsAvailable(NkGraphicsApi api) {
        switch (api) {
            ...
            case NkGraphicsApi::NK_GFX_API_VULKAN:    return NKENTSEU_ENABLE_VULKAN_BACKEND != 0;
            ...
            case NkGraphicsApi::NK_GFX_API_OPENGLES:  return true;
            case NkGraphicsApi::NK_GFX_API_VULKAN:    return NKENTSEU_ENABLE_VULKAN_BACKEND != 0;
            case NkGraphicsApi::NK_GFX_API_METAL:     return true;
            case NkGraphicsApi::NK_GFX_API_SOFTWARE:  return true;
            ...
            case NkGraphicsApi::NK_GFX_API_WEBGL:     return true;
            case NkGraphicsApi::NK_GFX_API_SOFTWARE:  return true;
#else
            case NkGraphicsApi::NK_GFX_API_OPENGL:    return true;
            case NkGraphicsApi::NK_GFX_API_VULKAN:    return NKENTSEU_ENABLE_VULKAN_BACKEND != 0;
