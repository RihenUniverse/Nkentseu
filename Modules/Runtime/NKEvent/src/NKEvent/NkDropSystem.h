...
//
// Sur chaque plateforme, le backend fenêtre/événement enregistre la fenêtre
// comme cible de drop et convertit les notifications OS en NkDropFileData /
// NkDropTextData qui sont injectées dans NkEventSystem.
//
