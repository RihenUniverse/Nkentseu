...
/**
 * @brief Timestamp en microsecondes (64-bit)
 * @ingroup TimeTypes
 */
using NkTimestamp = int64;

/**
 * @brief Durée en millisecondes (32-bit pour économiser mémoire)
 * @ingroup TimeTypes
 */
using NkDuration = uint32;

/**
 * @brief Durée en millisecondes 64-bit (pour longues durées)
 * @ingroup TimeTypes
 */
using NkDuration64 = uint64;
...
// ============================================================
// RE-EXPORT COMMON TYPES TO nkentseu NAMESPACE
// Makes uint8, uint32, etc. accessible in child namespaces
// ============================================================
namespace nkentseu {
using core::bool32;
using core::Boolean;
...
using core::nk_int8;
using core::nk_size;
using core::nk_uint16;
using core::nk_uint32;
using core::nk_uint64;
using core::nk_uint8;
using core::uint16;
using core::uint32;
using core::uint64;
