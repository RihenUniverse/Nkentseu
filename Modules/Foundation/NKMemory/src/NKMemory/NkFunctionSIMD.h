...
#ifndef NKENTSEU_MEMORY_NKFUNCTION_SIMD_H_INCLUDED
#define NKENTSEU_MEMORY_NKFUNCTION_SIMD_H_INCLUDED
...
#endif // NKENTSEU_MEMORY_NKFUNCTION_SIMD_H_INCLUDED
