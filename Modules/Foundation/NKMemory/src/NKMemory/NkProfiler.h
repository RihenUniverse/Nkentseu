...
#ifndef NKENTSEU_MEMORY_NKPROFILER_H_INCLUDED
...
namespace memory {
     ...
     */
    using AllocCallback = void (*)(void* ptr, nk_size size, const nk_char* tag);
    using FreeCallback = void (*)(void* ptr, nk_size size);
    using ReallocCallback = void (*)(void* oldPtr, void* newPtr, nk_size oldSize, nk_size newSize);
     ...
     */
    class NKENTSEU_MEMORY_API NkMemoryProfiler {
    public:
        /**
...
#endif // NKENTSEU_MEMORY_NKPROFILER_H_INCLUDED
