...
#ifndef NKENTSEU_MEMORY_NKTAG_H_INCLUDED
#define NKENTSEU_MEMORY_NKTAG_H_INCLUDED
...
namespace memory {
     ...
     */
    struct NKENTSEU_MEMORY_API NkMemoryTagStats {
     ...
     * par catégorie.
     */
    class NKENTSEU_MEMORY_API NkMemoryBudget {
    public:
        /**
...
#endif // NKENTSEU_MEMORY_NKTAG_H_INCLUDED
