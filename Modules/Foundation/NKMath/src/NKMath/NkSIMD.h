...
#define NKENTSEU_MATH_NKSIMD_H
    ...
    #if defined(NKENTSEU_CPU_HAS_SSE4_2) && (defined(NKENTSEU_PLATFORM_WINDOWS_64) || (defined(NKENTSEU_PLATFORM_LINUX) && defined(NKENTSEU_ARCH_X86_64)))
    ...
    #elif defined(NK_ENABLE_NEON) && (defined(NKENTSEU_PLATFORM_ANDROID) || defined(NKENTSEU_PLATFORM_IOS) || (defined(NKENTSEU_PLATFORM_LINUX) && defined(NKENTSEU_ARCH_ARM64)))
            ...
            namespace simd {
                ...
                ///@{
                    ...
                    struct nk_simd_vec4f {
                        nk_float32 data[4];
                        nk_float32& operator[](int i) noexcept { return data[i]; }
                        nk_float32  operator[](int i) const noexcept { return data[i]; }
                    };
                #endif
