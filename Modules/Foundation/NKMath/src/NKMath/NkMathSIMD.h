...
#ifndef NKENTSEU_NKMATH_NKMATHSIMD_H_INCLUDED
#define NKENTSEU_NKMATH_NKMATHSIMD_H_INCLUDED
...
namespace nkentseu {
    namespace math {
        namespace simd {
             ...
             */
            NK_FORCE_INLINE nk_simd_vec8f SqrtVec8(nk_simd_vec8f x) noexcept {
                // Newton: y = 0.5 * (y + x/y)
             ...
             */
            NK_FORCE_INLINE nk_simd_vec4f SqrtVec4(nk_simd_vec4f x) noexcept {
             ...
             */
            NK_FORCE_INLINE nk_simd_vec8f ExpFastVec8(nk_simd_vec8f x) noexcept {
             ...
             */
            NK_FORCE_INLINE nk_simd_vec8f SinFastVec8(nk_simd_vec8f x) noexcept {
                // Normalize to [0, 2π)
             ...
             */
            NK_FORCE_INLINE nk_simd_vec8f CosFastVec8(nk_simd_vec8f x) noexcept {
                const nk_simd_vec8f pi_2 = _mm256_set1_ps(1.570796327f);
                return SinFastVec8(_mm256_add_ps(x, pi_2));
            }
             ...
             */
            void SqrtBatch4(nk_float* values, nk_uint32 count) noexcept;

            /**
             * @brief Process 8 values (AVX2)
             * Speedup: 20-40x vs scalar!
             */
            void SqrtBatch8(nk_float* values, nk_uint32 count) noexcept;

            /**
             * @brief Exp batch processing
             */
            void ExpBatch8(nk_float* values, nk_uint32 count) noexcept;

            /**
             * @brief Sin batch processing (fast via LUT)
             */
            void SinBatch8(nk_float* values, nk_uint32 count) noexcept;

            /**
             * @brief Cos batch processing (fast via LUT)
             */
            void CosBatch8(nk_float* values, nk_uint32 count) noexcept;

        } // namespace simd
    } // namespace math
} // namespace nkentseu

#endif // NKENTSEU_NKMATH_NKMATHSIMD_H_INCLUDED
