...
\hypersetup{
  ...
  pdfsubject={\DocSujet},
  pdfcreator={XeLaTeX},
  pdfkeywords={Jenga, Nkentseu, Rihen, C++, systeme de construction, ENSPY1}}
...
\lstdefinestyle{nkcpp}{
  ...
  % ⚠️ NE PAS ajouter ici une regle pour le panneau « ⚠ » : ESSAYEE ET MESUREE
  % le 2026-09-02, elle NE MORD PAS dans un bloc de code -- ni en tete de liste,
  % ni apres `language={}`. Le caractere arrive brut a la police, qui ne le
  % porte pas, et le journal dit « Missing character » pendant que la
  % compilation reste verte. Ce qui marche est `escapeinside`, employe au cas
  % par cas dans les deux blocs concernes (11-le-mobile, 14-livrer).
  literate=
...
% laisse simplement TOMBER -- 17 panneaux absents du PDF de ce livre, 12 de
% celui du cours. Le journal le dit (`Missing character: There is no ⚠`), mais
