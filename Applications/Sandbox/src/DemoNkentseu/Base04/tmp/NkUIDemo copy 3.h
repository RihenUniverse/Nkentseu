    ...
    namespace nkui {
        ...
        class NkUIDemo {
            ...
            private:
                ...
                // nkui::NkColorPickerFull::State* dummy = nullptr;
        };
                                    ...
                                    float32 dt)
        {
            ...
            // Fond
            dl.AddRectFilled({0,0,(float32)ctx.viewW,(float32)ctx.viewH},
                            ctx.theme.colors.bgPrimary);
            ...
            const NkRect dockRect = {0, menuH,
                                    (float32)ctx.viewW,
                                    (float32)ctx.viewH - menuH};
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Graphiques",
                                    &mShowCharts)) return;
                                            ...
                                            NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Viewport 3D",
                                    &mShowViewport)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Textures",
                                    &mShowTextures)) return;
                                            ...
                                            NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Color Picker",
                                    &mShowColor)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Style éditeur",
                                    &mShowStyle)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Console",
                                    &mShowConsole)) return;
            ...
            NkUI::BeginScrollRegion(ctx, ls, "##consolescroll", scrollR,
                                    nullptr, &mConsole.scrollY);
                                    ...
                                    NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Performances",
                                    &mShowPerf)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "À propos de NkUI",
                                    &mShowAbout,
                                    NkUIWindowFlags::NK_NO_RESIZE)) return;
                                            ...
                                            NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Widgets avancés",
                                    &mShowWidgets2)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, ls, "Scène 3D — Propriétés",
                                    &mShowScene3D)) return;
                                            ...
                                            int32 meshType, bool wireframe, bool showGrid)
        {
            ...
            const float32 nearplan = 0.1f, farplan = 100.f;
            const float32 f    = 1.f / ::tanf(fov*0.5f);
            float32 matProj[16] = {
                f/asp, 0,  0,                            0,
                0,     f,  0,                            0,
                0,     0, (farplan+nearplan)/(nearplan-farplan),         -1,
                0,     0, (2*farplan*nearplan)/(nearplan-farplan),        0
            };
                ...
                if (wireframe) {
                    ...
                    for (int32 e = 0; e < 3; ++e) {
                        ...
                        for (int32 s = 0; s <= steps; ++s) {
                            ...
                            if(px>=0&&px<w&&py>=0&&py<h) {
                                fb[py*w+px] = {wc.r, wc.g, wc.b, wc.a};
                            }
                        }
                    }
                } else {
