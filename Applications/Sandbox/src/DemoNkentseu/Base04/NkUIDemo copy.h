...
namespace nkentseu {
    namespace nkui {
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Widgets", &mShowWidgets, NkUIWindowFlags::NK_MODAL)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Graphiques",
                                    &mShowCharts)) return;
                                            ...
                                            NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Viewport 3D",
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Textures",
                                            ...
                                            NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Color Picker",
                                    &mShowColor)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Style éditeur",
                                    &mShowStyle)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Console",
                                    &mShowConsole)) return;
                                    ...
                                    NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Performances",
                                    &mShowPerf)) return;
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "À propos de NkUI",
                                    &mShowAbout,
                                            ...
                                            NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Widgets avancés",
                                        ...
                                        NkUIFont& font)
        {
            ...
            if (!NkUIWindow::Begin(ctx, wm, dl, font, "Scène 3D — Propriétés",
                                    &mShowScene3D)) return;
