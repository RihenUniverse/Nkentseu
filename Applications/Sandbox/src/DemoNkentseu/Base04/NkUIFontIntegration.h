    ...
    namespace nkui {
        ...
        class NKUI_API NkUIFontLoader {
            ...
            private:
                ...
                void ComputeMetricsFromFTFont(NkFTFontFace* face, NkUIFontMetrics& outMetrics) noexcept;
                void PreloadASCIIFromFTFont(NkFTFontFace* face) noexcept;
                bool RasterizeGlyphToAtlas(NkFTFontFace* face, uint32 codepoint, NkUIGlyph& outGlyph) noexcept;
        };
