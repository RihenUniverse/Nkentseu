...
| Le composant se propage à ses instances **sauf** là où une surcharge existe | — | ❌ **absent — et la RÈGLE a changé (Q51, 02/09)** | 📌 **Rodolf a tranché l'inverse de Lunacy** : les instances ne suivent **pas** automatiquement — la mise à jour est un **acte explicite** de l'instance, et elle respecte les bits surchargés (une surcharge tient). Trois états à porter : à jour / **en retard** (visible sur la pilule) / détachée. Modifier un composant propose copie ou en-place — **toujours la copie** pour ce qui ne m'appartient pas, sans dialogue. Cf. §15.6 R1–R3, ses mots cités |
