...
| **Mode de fusion PAR REMPLISSAGE** (18 modes : Normal, Darken, Multiply, Plus Darker, Color Burn, Lighten, Screen, Plus Lighter, Color Dodge, Overlay, Soft Light, Hard Light, Difference, Exclusion, Hue, Saturation, Color, Luminosity) | ❌ **absent** | capture 04/09, icône en goutte du popover. **Distinct** du mode de fusion du CALQUE (section `LAYER`). Rendre 18 modes justes est un chantier à soi : nommé, pas esquissé |
