...
- **[`NkAssertHandler`](../files/NkAssertHandler.h.md#nkasserthandler-nkasserthandler)** — Type de callback pour assertions
- **[`NkAssertHandler`](../files/NkAssertHandler.h.md#nkasserthandler-nkasserthandler-nkasserthandler)** — Gestionnaire global d'assertions
- **[`NkBits`](../files/NkBits.h.md#nkbits-nkbits)** — Classe utilitaire pour manipulation avancée de bits
- **[`NkScopedSpinLock`](../files/NkAtomic.h.md#nkmemoryorder-nkspinlock-nkspinlock-nkscopedspinlock-nkscopedspinlock)** — Scope guard pour spinlock
- **[`NkSpinLock`](../files/NkAtomic.h.md#nkmemoryorder-nkspinlock-nkspinlock)** — Soustrait atomiquement et retourne la nouvelle valeur
- **[`NkSpinLock`](../files/NkAtomic.h.md#nkmemoryorder-nkspinlock-nkspinlock-nkspinlock)** — Spinlock avec backoff exponentiel

### ⚙️ Functions (9)

- **[`DefaultCallback`](../files/NkAssertHandler.h.md#defaultcallback)** — Callback par défaut
- **[`HandleAssertion`](../files/NkAssertHandler.h.md#handleassertion)** — Gère une assertion échouée
- **[`NK_BYTESWAP16`](../files/NkBits.h.md#nk_byteswap16)** — Inverse l'ordre des octets (16-bit)
- **[`NK_CTZ64`](../files/NkBits.h.md#nk_ctz64)** — Macro pour compter les zéros à droite (64-bit)
- **[`NkAbs`](../files/NkInline.h.md#nkabs)**
- **[`NkAdd`](../files/NkInline.h.md#nkadd)**
- **[`NkHandleError`](../files/NkInline.h.md#nkhandleerror)**
- **[`NkProcessFrame`](../files/NkInline.h.md#nkprocessframe)**
- **[`NkSquareRoot`](../files/NkInline.h.md#nksquareroot)**
...
- **[`NkAssertionInfo`](../files/NkAssertion.h.md#nkassertioninfo-nkassertioninfo)** — Informations sur une assertion échouée
- **[`NkNumericLimits`](../files/NkLimits.h.md#nknumericlimits-nknumericlimits)** — Limites pour types entiers (template)

### 📦 Variables (3)

- **[`index`](../files/NkBits.h.md#index)** — Macro pour compter les zéros à droite (32-bit)
- **[`index`](../files/NkBits.h.md#index)** — Macro pour compter les zéros à gauche (32-bit)
- **[`index`](../files/NkBits.h.md#index)** — Macro pour compter les zéros à gauche (64-bit)
