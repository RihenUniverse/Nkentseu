...
[B](#b) [C](#c) [D](#d) [E](#e) [F](#f) [G](#g) [H](#h) [I](#i) [L](#l) [N](#n) [P](#p) [R](#r) [S](#s) [U](#u) [V](#v) [_](#_) 
...
- 🏗️ **[`Byte`](./files/NkTypes.h.md#nkentseu-byte-byte)** — Structure wrapper pour byte avec opérateurs * Encapsule un uint8 avec des opérations bitwise et conversions sécurisées. *
...
- ⚙️ **[`DefaultCallback`](./files/NkAssertHandler.h.md#defaultcallback)** — Callback par défaut
...
- ⚙️ **[`from`](./files/NkTypes.h.md#nkentseu-from)** — Conversion sécurisée depuis un type
...
- ⚙️ **[`HandleAssertion`](./files/NkAssertHandler.h.md#handleassertion)** — Gère une assertion échouée
...
- 🏗️ **[`int128`](./files/NkTypes.h.md#nkentseu-int128)** — Conversion vers un type
...
- 🔧 **[`NextPowerOfTwo`](./files/NkBits.h.md#nkbits-nextpoweroftwo)** — Arrondit vers le haut à la prochaine puissance de 2
- ⚙️ **[`NK_BYTESWAP16`](./files/NkBits.h.md#nk_byteswap16)** — Inverse l'ordre des octets (16-bit)
- 🔣 **[`NK_CORE_API`](./files/NkCoreExport.h.md#nk_core_api)** — Alias court pour NKENTSEU_CORE_API
- ⚙️ **[`NK_CTZ64`](./files/NkBits.h.md#nk_ctz64)** — Macro pour compter les zéros à droite (64-bit)
- 🔣 **[`NK_GFX_API`](./files/NkGraphicsExport.h.md#nk_gfx_api)** — Alias court pour NKENTSEU_GRAPHICS_API
- ⚙️ **[`NkAbs`](./files/NkInline.h.md#nkabs)**
- 🔣 **[`NkAbs`](./files/NkMacros.h.md#nkabs)** — Retourne la valeur absolue
- ⚙️ **[`NkAdd`](./files/NkInline.h.md#nkadd)**
...
- 🔧 **[`NkAlignAddressConst`](./files/NkPlatform.h.md#nkentseu-nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkalignaddressconst)** — Aligne une adresse constante vers le haut
- 🔧 **[`NkAlignDown`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkaligndown)** — Aligne une adresse vers le bas
...
- 🔧 **[`NkAlignUp`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkalignup)** — Aligne une adresse vers le haut
- 🔣 **[`NkAlignUp`](./files/NkTypeUtils.h.md#nkalignup)** — Aligne une valeur vers le haut
- 🔣 **[`NkAllocAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nkallocaligned)** — Alloue mémoire alignée sur cache line
- 🔧 **[`NkAllocateAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkallocatealigned)** — Alloue de la mémoire alignée
- 🔧 **[`NkAllocateAlignedArray`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkallocatealignedarray)** — Alloue un tableau d'éléments alignés
- 🔣 **[`NkAllocPageAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nkallocpagealigned)** — Alloue mémoire alignée sur page
...
- 🏛️ **[`NkAssertHandler`](./files/NkAssertHandler.h.md#nkasserthandler-nkasserthandler)** — Type de callback pour assertions
- 🏛️ **[`NkAssertHandler`](./files/NkAssertHandler.h.md#nkasserthandler-nkasserthandler-nkasserthandler)** — Gestionnaire global d'assertions
- 🏗️ **[`NkAssertionInfo`](./files/NkAssertion.h.md#nkassertioninfo-nkassertioninfo)** — Informations sur une assertion échouée
...
- 🏛️ **[`NkBits`](./files/NkBits.h.md#nkbits-nkbits)** — Classe utilitaire pour manipulation avancée de bits
...
- 🔧 **[`NkCalculatePadding`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkcalculatepadding)** — Calcule le padding nécessaire pour l'alignement
- 🔣 **[`NkCCast`](./files/NkTypeUtils.h.md#nkentseu-nkentseu-nkccast)** — Cast de type C-style (à éviter)
...
- 🔧 **[`NkConstructAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkconstructaligned)** — Construit un objet dans de la mémoire alignée
...
- 📝 **[`NkDegrees`](./files/NkTypes.h.md#nkentseu-nkentseu-nkentseu-nkdegrees)** — Angle en degrés (float par défaut)
- 🔣 **[`NkDegreesToRadians`](./files/NkMacros.h.md#nkdegreestoradians)** — Convertit degrés en radians
- 🔧 **[`NkDestroyAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nkdestroyaligned)** — Détruit un objet dans de la mémoire alignée
- 📝 **[`NkDuration`](./files/NkTypes.h.md#nkentseu-nkentseu-nkduration)** — Durée en millisecondes (32-bit pour économiser mémoire)
- 📝 **[`NkDuration64`](./files/NkTypes.h.md#nkentseu-nkentseu-nkentseu-nkduration64)** — Durée en millisecondes 64-bit (pour longues durées)
...
- 🔧 **[`NkFreeAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkfreealigned)** — Libère de la mémoire allouée avec AllocateAligned
- 🔣 **[`NkFreeAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nkfreealigned)** — Libère mémoire alignée
- ⚙️ **[`NkFromHandle`](./files/NkTypeUtils.h.md#nkentseu-nkentseu-nkfromhandle)** — Convertit un handle en pointeur
...
- 🔧 **[`NkGetArchName`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkgetarchname)** — Retourne le nom de l'architecture
- 🔧 **[`NkGetArchVersion`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkgetarchversion)** — Retourne la version de l'architecture
...
- 🔧 **[`NkGetCacheLineSize`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkgetcachelinesize)** — Retourne la taille de ligne de cache
...
- 🔧 **[`NkGetPageSize`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkgetpagesize)** — Retourne la taille de page mémoire
...
- 🔧 **[`NkGetPlatformName`](./files/NkPlatform.h.md#nkentseu-nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkgetplatformname)** — Fonctions inline pour informations plateforme compile-time
- 🔧 **[`NkGetPlatformName`](./files/NkPlatform.h.md#nkentseu-nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkgetplatformname)** — Retourne le nom de la plateforme (compile-time)
- 🔧 **[`NkGetPlatformVersion`](./files/NkPlatform.h.md#nkentseu-nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkgetplatformversion)** — Retourne la version/description de la plateforme
...
- 🔧 **[`NkGetWordSize`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkgetwordsize)** — Retourne la taille de mot machine
...
- ⚙️ **[`NkHandleError`](./files/NkInline.h.md#nkhandleerror)**
...
- 🔧 **[`NkIs32Bit`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkis32bit)** — Vérifie si l'architecture est 32-bit
...
- 🔧 **[`NkIs64Bit`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkis64bit)** — Vérifie si l'architecture est 64-bit
...
- 🔧 **[`NkIsAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkisaligned)** — Vérifie si une adresse est alignée
- 🔣 **[`NkIsAligned`](./files/NkTypeUtils.h.md#nkisaligned)** — Vérifie si une valeur est alignée
- 🔧 **[`NkIsBigEndian`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkisbigendian)** — Vérifie si l'architecture est big-endian
- 🔧 **[`NkIsConsole`](./files/NkPlatform.h.md#nkentseu-nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkisconsole)** — Vérifie si la plateforme est une console
...
- 🔧 **[`NkIsDesktop`](./files/NkPlatform.h.md#nkentseu-nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkisdesktop)** — Vérifie si la plateforme est desktop
- 🔧 **[`NkIsEmbedded`](./files/NkPlatform.h.md#nkentseu-nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkisembedded)** — Vérifie si la plateforme est embarquée
- 🔧 **[`NkIsLittleEndian`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkislittleendian)** — Vérifie si l'architecture est little-endian
- 🔧 **[`NkIsMobile`](./files/NkPlatform.h.md#nkentseu-nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkismobile)** — Vérifie si la plateforme est mobile
- 🔧 **[`NkIsPointerAligned`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-memory-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkispointeraligned)** — Vérifie si un pointeur est aligné
...
- 🔧 **[`NkIsWeb`](./files/NkPlatform.h.md#nkentseu-nkentseu-arch-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nkisweb)** — Vérifie si la plateforme est web
...
- 🏗️ **[`NkNumericLimits`](./files/NkLimits.h.md#nknumericlimits-nknumericlimits)** — Limites pour types entiers (template)
- 🔣 **[`NkOffsetOf`](./files/NkTypeUtils.h.md#nkoffsetof)** — Calcule l'offset d'un membre dans une structure
- 🏗️ **[`NkPlatformInfo`](./files/NkPlatform.h.md#nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nkplatforminfo)** — Informations complètes sur la plateforme runtime
...
- ⚙️ **[`NkProcessFrame`](./files/NkInline.h.md#nkprocessframe)**
- 📝 **[`NkRadians`](./files/NkTypes.h.md#nkentseu-nkentseu-nkentseu-nkradians)** — Angle en radians (float par défaut)
- 🔣 **[`NkRadiansToDegrees`](./files/NkMacros.h.md#nkradianstodegrees)** — Convertit radians en degrés
- 📝 **[`NkReal`](./files/NkTypes.h.md#nkentseu-nkentseu-nkentseu-nkreal)** — Type flottant par défaut pour calculs mathématiques
- 🔣 **[`NkReinterpretCast`](./files/NkTypeUtils.h.md#nkreinterpretcast)** — Reinterpret cast (dangereux)
- ⚙️ **[`NkSafeCast`](./files/NkTypeUtils.h.md#nkentseu-nksafecast)** — Cast sécurisé avec vérification debug
- 🏛️ **[`NkScopedSpinLock`](./files/NkAtomic.h.md#nkmemoryorder-nkspinlock-nkspinlock-nkscopedspinlock-nkscopedspinlock)** — Scope guard pour spinlock
- 🔣 **[`NkSetBit`](./files/NkTypeUtils.h.md#nksetbit)** — Met un bit à 1
- 🏛️ **[`NkSourceLocation`](./files/NkPlatform.h.md#nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkplatforminfo-nksourcelocation-nksourcelocation)** — Informations de localisation dans le code source
- 🏛️ **[`NkSpinLock`](./files/NkAtomic.h.md#nkmemoryorder-nkspinlock-nkspinlock)** — Soustrait atomiquement et retourne la nouvelle valeur
- 🏛️ **[`NkSpinLock`](./files/NkAtomic.h.md#nkmemoryorder-nkspinlock-nkspinlock-nkspinlock)** — Spinlock avec backoff exponentiel
- ⚙️ **[`NkSquareRoot`](./files/NkInline.h.md#nksquareroot)**
...
- ⚙️ **[`NkToHandle`](./files/NkTypeUtils.h.md#nkentseu-nkentseu-nktohandle)** — Convertit un pointeur en handle
...
- 🏗️ **[`NkVersionInfo`](./files/NkPlatform.h.md#nkentseu-nkplatformtype-nkplatformtype-nkarchitecturetype-nkdisplaytype-nkgraphicsapi-nkendianness-nkversioninfo-nkversioninfo)** — Informations de version (Major.Minor.Patch)
...
- ⚙️ **[`SafeConstCast`](./files/NkTypes.h.md#nkentseu-safeconstcast)** — Conversion sécurisée de ConstVoidPtr vers T*
