...
typedef int ImGuiFolder;               // -> enum ImGuiDir_             // Enum: A cardinal direction
...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_Folder               = 1 << 15,  // FIXME: TODO: Disable automatic scroll on TreePop() if node got just open and contents is not visible
    ImGuiTreeNodeFlags_FolderFile           = 1 << 16,  // FIXME: TODO: Disable automatic scroll on TreePop() if node got just open and contents is not visible
...
struct ImFolderTextureID
{
    ImTextureID FolderOpen = nullptr;
    ImTextureID FolderClose = nullptr;
    ImTextureID FolderFile = nullptr;
    ImTextureID FolderEmpty = nullptr;

    bool Empty = false;
    bool OpenIt = false;

    ImFolderTextureID(){}
    ImFolderTextureID(ImTextureID folderOpen, ImTextureID folderClose, ImTextureID folderFile, ImTextureID folderEmpty);
    IMGUI_API void  SetFolderInformation(ImTextureID folderOpen, ImTextureID folderClose, ImTextureID folderFile, ImTextureID folderEmpty);

    static ImFolderTextureID ImFolderTextureIDSource;
};
