...
> 🧭 **2026-09-04, fin de journée** — la conversion pose → monde (FK) n'existe qu'en un endroit
> (`Skeleton/NkSkeletonDef.h` : `NkForwardKinematics`, `LocalToWorld`) ; le ragdoll de NKPhysics se
