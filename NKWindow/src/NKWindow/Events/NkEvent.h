...
// ---------------------------------------------------------------------------
// Types de base (normalement issus de NkTypes.h)
// ---------------------------------------------------------------------------
using NkU8  = uint8_t;
...
namespace nkentseu {
    ...
    // Note: These are for backward compatibility with older event data types
    // Modern code should use the actual event classes (NkKeyboardEvent, etc.)
    // For now, we use workaround aliases pointing to what they should be
